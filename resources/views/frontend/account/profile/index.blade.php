 ...
 <div class="body-content">
  <div class="container">
   <div class="row">
    ...
    <div class="col-md-6">
     <div class="card">
      <h3 class="text-center"><span class="text-primary">Logged in as:</span> <strong>{{ Auth::user()->first_name }} </strong></h3>
      <h5 class="text-center"><span class="text-info">email:</span> <strong>{{ Auth::user()->email }} </strong></h5>
     </div>
     <div class="container">
