               ...
               <tbody>
                @foreach ($categories as $item)
                 <tr>
                  ...
                  <td class="d-flex">
                   <a href="{{ route('admin.categories.edit', $item) }}" class="btn btn-info btn-md btn-clean btn-icon" title="Edit"><i class="fa fa-edit"></i></a>



                <form  action="{{ route('admin.categories.destroy', $item->id) }}" method="POST" class="ml-3">
                    @csrf
                    @method('DELETE')
                    <button type="submit"  href="{{ route('admin.categories.destroy', $item->id) }}" class="btn btn-danger  btn-md btn-clean btn-icon" title="Delete" >
